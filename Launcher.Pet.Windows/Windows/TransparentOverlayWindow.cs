using static Launcher.Pet.Windows.Windows.TransparentWindowApi;
...
internal class TransparentOverlayWindow : Form
{
    ...
    private void UploadImage()
    {
        ...
        try
        {
            ...
            if (!UpdateLayeredWindow(Handle, IntPtr.Zero, ref destination, ref size, memoryDc, ref source, 0, ref blend, 2)) // ULW_ALPHA
                throw new Win32Exception(Marshal.GetLastWin32Error());
        }
        finally
        {
